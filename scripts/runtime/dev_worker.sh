...
[dev_worker]   SQLITE_PATH=${SQLITE_PATH:-$HOME/.sourceharbor/state/worker_state.db}
...
[dev_worker]   PIPELINE_WORKSPACE_DIR=${PIPELINE_WORKSPACE_DIR:-$HOME/.sourceharbor/workspace}
[dev_worker]   PIPELINE_ARTIFACT_ROOT=${PIPELINE_ARTIFACT_ROOT:-$HOME/.sourceharbor/artifacts}
