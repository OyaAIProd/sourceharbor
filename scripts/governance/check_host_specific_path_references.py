...
def main() -> int:
    ...
    if errors:
        ...
        for item in errors:
            print(f"  - {item}")
        print(
            "  - remediation: keep only controlled execution paths like /workspace or /tmp/sourceharbor* in public canonical surfaces; remove maintainer-specific absolute paths and old workspace prefixes"
        )
        return 1
