...
| **OpenClaw** | Generic-adjacent, but still no dedicated pack | the shared MCP / HTTP substrate is real, but repo-side proof is still not strong enough to justify a named primary or first-cut OpenClaw binding |
