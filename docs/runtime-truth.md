...
| **Long live smoke** | the strict smoke lane is real, but current closure still depends on provider-side YouTube preflight and sender configuration rather than repo-local code alone |
