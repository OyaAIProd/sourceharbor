...
| **Build on top of SourceHarbor** | [builders.md](./builders.md) | How Codex, Claude Code, MCP clients, API consumers, public packages, and starter packs fit the current repo truth |
